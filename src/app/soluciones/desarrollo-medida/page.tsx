...
function CodeTypewriter() {
  const codeLines = [
    '// VoXAI SDK — conecta en minutos',
    'const voxai = new VoxAI({ apiKey });',
    '',
    'await voxai.integrate({',
    '  crm: "hubspot",',
    '  trigger: "call.ended",',
    '  action: async (call) => {',
    '    await crm.createDeal(call.summary);',
    '    await whatsapp.notify(call.agent);',
    '  }',
    '});'
  ];
            ...
            {isComment ? (
              ...
              <span>
                {safeLine.split(/(\s+)/).map((part, pIdx) => {
                  ...
                  if (part === 'integrate' || part === 'createDeal' || part === 'notify') {
...
const features = [
  {
    ...
    description: 'Conectamos tu plataforma VoIP con Salesforce, HubSpot, SAP, Zoho o cualquier sistema que uses. Sin fricción entre herramientas.',
  },
  {
    icon: LayersIcon,
    title: 'Desarrollo de portales personalizados',
    description: 'Paneles de administración, dashboards operativos o interfaces de agente completamente adaptadas a tu flujo de trabajo.',
  },
  {
    icon: GitMergeIcon,
    title: 'APIs y webhooks a la medida',
    description: 'Exposición de endpoints propios para que tus sistemas disparen llamadas, registren eventos o consulten datos en tiempo real.',
  },
  {
    icon: ShieldIcon,
    title: 'Desarrollos seguros y escalables',
    description: 'Arquitectura cloud-first con estándares de seguridad empresarial. Tu desarrollo crece junto con tu operación.',
  },
];

const resultados = [
  { value: '100%', label: 'Adaptado a ti', sub: 'no un template genérico' },
...
const checklist = [
  'Integración con cualquier CRM o ERP',
  'APIs REST / Webhooks personalizados',
  'Portal de administración a medida',
  'Dashboard de reportería personalizado',
  'SSO e integración con directorio corporativo',
          ...
          <div className="flex flex-col items-start max-w-[540px]">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-[46px] leading-[1.2] tracking-tight mb-5">
              <span className="font-light block mb-2" style={{ color: '#64748B' }}>
                Tu operación tiene necesidades únicas.
              </span>
            ...
            <p className="text-[14px] leading-[1.6] mb-8 max-w-[420px]" style={{ color: '#475569' }}>
              Integramos tu plataforma de comunicaciones con tus sistemas actuales y construimos exactamente lo que tu equipo necesita. Diseñamos y entregamos tu MVP de forma extremadamente rápida y económica.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-left mb-12 max-w-xl">
            ...
            <p className="text-[14px] leading-[1.6]" style={{ color: '#475569' }}>
              Desde integraciones puntuales hasta plataformas completas. Adaptadas a tu stack, tus tiempos y tu equipo.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {features.map((f, i) => {
              const Icon = f.icon;
              // Bento layout: items 0 ( CRM) and 3 (Security) take 2/3 width, items 1 (Portals) and 2 (APIs) take 1/3 width
            ...
            >
              <div>
                ...
                <p className="text-[14px] leading-[1.6] mb-8" style={{ color: '#475569' }}>
                  Cuéntanos qué necesitas conectar o construir. Diseñamos y desarrollamos tu MVP de forma extremadamente rápida y económica para validar tus ideas al instante.
                </p>
              </div>
